...
DateI18nEN_timeInWords i18n;

Clockface_timeInWords::Clockface_timeInWords(Adafruit_GFX* display)
{
  _display = display;
...
void Clockface_timeInWords::setup(CWDateTime *dateTime) {
...
void Clockface_timeInWords::update() 
{  
...
void Clockface_timeInWords::updateTime() 
{
...
void Clockface_timeInWords::updateDate() 
{
...
void Clockface_timeInWords::updateTemperature() 
{
