...
const uint8_t hour8pt7bBitmaps_timeInWords[] PROGMEM = {
...
const GFXglyph hour8pt7bGlyphs_timeInWords[] PROGMEM = {
  {     0,   2,   1,   4,    1,    0 }   // ' '
 ,{     1,   2,  14,   3,    0,  -13 }   // '!'
 ,{     5,   8,   6,   9,    0,  -13 }   // '"'
 ,{    11,  10,  13,  11,    0,  -13 }   // '#'
...
const GFXfont hour8pt7b_timeInWords PROGMEM = {
  (uint8_t  *)hour8pt7bBitmaps_timeInWords,    
  (GFXglyph *)hour8pt7bGlyphs_timeInWords, 0x20, 0x7e,     15 };
