...
class Clockface_pacman: public IClockface {
  private:
    ...
    void drawMap();
    Clockface_pacman::MapBlock nextBlock(Direction dir);
    Clockface_pacman::MapBlock nextBlock();
    void turnRandom();
    int countBlocks(Clockface_pacman::MapBlock elem);
  ...
  public:
    Clockface_pacman(Adafruit_GFX* display);
