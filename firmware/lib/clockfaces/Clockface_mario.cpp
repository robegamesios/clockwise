...
Clockface_mario::Clockface_mario(Adafruit_GFX* display) {
  _display = display;
...
void Clockface_mario::setup(CWDateTime *dateTime) {
  _dateTime = dateTime;
